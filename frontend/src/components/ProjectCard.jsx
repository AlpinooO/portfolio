export default function ProjectCard({ project, index }) {
  return (
<article className="editorial-card p-6 bg-surface hover:border-cyan/50 hover:-translate-y-1 hover:shadow-lg transition-all">      <div className="flex items-start justify-between mb-4">
